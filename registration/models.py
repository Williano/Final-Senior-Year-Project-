...
class Profile(models.Model):
    ...
    image = models.ImageField(upload_to='user_accounts', null=True, default='media/avatar.jpg',
                              help_text="Your photo (not an illustration nor avatar), It will be published on the website. Ideal photo is: a head shot, shows only you, has no “filters” applied and is as large and uncompressed as possible. We might crop it and change contrast, brightness etc. to fit our visual style.", blank=True)
    bio = models.TextField(max_length=500, help_text="Tell us a bit about yourself", blank=False)
    ...
    phone_number = models.CharField(_('phone number'), validators=[phone_regex], max_length=17,
                                    help_text="Please include your country code.", blank=False)
